...
PFINTERNAL_FQ_PACKAGE=pathfingerprint/pfinternal
PFINTERNAL_SOURCEFILES=src/${PFINTERNAL_FQ_PACKAGE}/*.go
...
all: test bin/${PFHASH_EXECUTABLE_FILENAME} bin/${PFLOOKUP_EXECUTABLE_FILENAME}

test: ${PFINTERNAL_SOURCEFILES}
	go test ${PFINTERNAL_FQ_PACKAGE}
